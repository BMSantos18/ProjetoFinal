 ...
 * @author Xtream
 */
public class JfrmHistoricoVendas extends javax.swing.JFrame {
    DefaultTableModel tmVenda = new DefaultTableModel(null, new String[]{"Nome","Produto","Total","Data"});
    List<HistoricoVendas> venda;
    ListSelectionModel lsmVenda;
    
    
    private void mostraPesquisa(List<HistoricoVendas> vendas){
        while(tmVenda.getRowCount()>0){
            tmVenda.removeRow(0);
        }
        if(vendas.size()==0){
            JOptionPane.showMessageDialog(null, "Nenhuma venda foi feita");
        }else{
            String[] linha = new String[]{null, null, null, null};
            for(int i = 0; i < vendas.size();i++){
                tmVenda.addRow(linha);
                tmVenda.setValueAt(vendas.get(i).getNomeFuncionario(),i,0);
                tmVenda.setValueAt(vendas.get(i).getProduto(),i,1);
                tmVenda.setValueAt(vendas.get(i).getPrecoTotal(),i,2);
                tmVenda.setValueAt(vendas.get(i).getData_venda(),i,3);
            }
        }
    }
    ...
    public void ListarVendas()throws Exception{
        Banco dao = new Banco();
        venda = dao.getVendas("%" + txtDe.getText()+ "%");
        mostraPesquisa(venda);
    }
    
    public JfrmHistoricoVendas() {
        initComponents();
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JfrmHistoricoVendas().setVisible(true);
            }
        });
    }
